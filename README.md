...
imagehash-package can be sufficient for near-duplicate detection, when `const numBuckets` is set to a very high value.
...
const (
	...
	// This example uses 10-dimensional vectors, splitting the 10D space into
